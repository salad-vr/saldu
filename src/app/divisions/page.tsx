              ...
              >
                <div className={i % 2 === 1 ? "lg:order-2" : ""}>
                  <div className="w-14 h-14 rounded-xl bg-gold-500/10 flex items-center justify-center mb-5">
                    <division.icon size={28} className="text-gold-600" />
                  </div>
                ...
                <div className={i % 2 === 1 ? "lg:order-1" : ""}>
                  <div className="aspect-[4/3] bg-gradient-to-br from-navy-100 to-navy-50 rounded-2xl flex items-center justify-center relative overflow-hidden">
                    <division.icon
                      size={80}
